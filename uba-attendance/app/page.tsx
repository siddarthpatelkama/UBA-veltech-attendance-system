  ...
  return (
    <div className="relative min-h-screen bg-white overflow-hidden font-sans flex flex-col items-center justify-center">
      ...
      <div className="relative flex flex-col items-center justify-center w-full mb-20">
        ...
        {/* PHASE 1-4: UBA LOGO (Full un-cropped image) */}
        {phase > 0 && phase < 5 && (
          <div className="flex flex-col items-center w-full px-6">
             ...
             <div className="flex flex-col items-center text-6xl md:text-7xl font-black italic tracking-tighter">
                <div className="flex gap-2">
                  <span className={`transition-colors duration-[1500ms] ease-in-out ${phase >= 1 ? 'animate-slide-up' : 'opacity-0'} ${phase >= 4 ? 'text-[#FF5722]' : 'text-gray-900'}`}>U</span>
                  <span className={`transition-colors duration-[1500ms] ease-in-out ${phase >= 2 ? 'animate-slide-up' : 'opacity-0'} ${phase >= 4 ? 'text-[#FF5722]' : 'text-gray-900'}`}>B</span>
                  <span className={`transition-colors duration-[1500ms] ease-in-out ${phase >= 3 ? 'animate-slide-up' : 'opacity-0'} ${phase >= 4 ? 'text-[#FF5722]' : 'text-gray-900'}`}>A</span>
                </div>
